...
<style>
    ...
    /* #7: Enhanced alternating row colors (subtle) */
...
st.markdown(f"""
<div style='text-align: center; padding: 30px 20px 20px 20px; margin-top: 60px; border-top: 1px solid #e0e2e6; background: linear-gradient(to bottom, transparent, rgba(240, 242, 246, 0.3)); color: #666; font-size: 0.9em;'>
